...
public class MNCalendarVerticalConfig {
    ...
    //显示多少月(默认6个月)
    private int mnCalendar_countMonth = 12;
    //是否是单选
    private boolean issingine = false;

    private boolean isStartTime = false;//是否是开始时间
    ...
    public static class Builder {
        ...
        public Builder setIsStartTimePick(boolean isStartTimePick) {
            mnCalendarConfig.setStartTime(isStartTimePick);
            return this;
        }
